...
public class SecondForm extends JFrame {
	...
	String data[][];
	String columnnames[];
public static String kvydache(String zarplata, String nalog){
	
	String vydat=String.valueOf((int)(Float.valueOf(zarplata)-Float.valueOf(nalog)));
	return vydat;
}
	/**
			...
			public void actionPerformed(ActionEvent e) {
                ...
                if (ret == JFileChooser.APPROVE_OPTION) {
					...
					data[i][10] = String.valueOf((int)(Float.valueOf(data[i][5])*0.002));
						data[i][11] = kvydache(data[i][5],data[i][6]);
					}
