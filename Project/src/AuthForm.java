...
public class AuthForm extends JFrame {
	 ...
	 */
	public static byte login(String log,String pass){
		byte passed = 0;
		if (log.equals("1") && pass.equals("1")) passed=1;
		if (log.equals("2") && pass.equals("2")) passed=2;
		return passed;
	}
	...
	public AuthForm() {
		...
		buttonAuth.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String logo=loginField.getText();
				String pword=passwordField.getText();
				if (login(logo,pword)==1)				  
				{
				FirstForm fr1 = new FirstForm();
				fr1.setVisible(true);	
				setVisible(false);
				}
			else  if (login(logo,pword)==2)
				{
